...
public class City extends JFrame {
	 ...
	 * 
	 */
	private static final long serialVersionUID = 4882215645744957792L;
	private JPanel contentPane;
	private JButton btnCancel, sb, btnlogOut;
	private JTextField txt;
	private JLabel back;
	JLabel pic, disp1, disp2, disp3, disp4, disp5;
	String[] cities = { "Bangalore", "Chennai", "Mangalore", "Hyderabad", "Mumbai" };
	...
	public City() {
		...
		pic.add(disp1);
		SetImageSize(disp1,
				new ImageIcon("/Users/kanishkamishra/git/SmartCity-Application/SmartCity/img/Bangalore/bang2.jpg"));

		disp2 = new JLabel();
		disp2.setBounds(340, 80, 220, 190);
		disp2.setVisible(true);
		pic.add(disp2);
		SetImageSize(disp2, new ImageIcon(
		...
		pic.add(disp3);
		SetImageSize(disp3,
				new ImageIcon("/Users/kanishkamishra/Desktop/SmartCity-Application/SmartCity/img/Bangalore/mang2.jpg"));
		...
		pic.add(disp5);
		SetImageSize(disp5, new ImageIcon(
		...
		JScrollPane scrollPane = new JScrollPane(textArea_1, JScrollPane.VERTICAL_SCROLLBAR_ALWAYS,
		...
		JScrollPane scrollPane5 = new JScrollPane(textArea_5, JScrollPane.VERTICAL_SCROLLBAR_AS_NEEDED,
				JScrollPane.HORIZONTAL_SCROLLBAR_AS_NEEDED);
		pic.add(scrollPane5);
		...
		//Loop to add list of cities to the combo box
	...
	//function to set the image size in accordance with the Jlabel 
