...
public class FrameDisplayMumbai {
	...
	public FrameDisplayMumbai() {
		...
		SetImageSize(lalbagh,
				new ImageIcon("/Users/kanishkamishra/Desktop/SmartCity-Application/SmartCity/img/slide/mumbai4.jpg"));

		JLabel lalbagh1 = new JLabel();
		lalbagh1.setBounds(500, 320, 450, 200);
		back.add(lalbagh1);
		SetImageSize(lalbagh1, new ImageIcon(
				"/Users/kanishkamishra/Desktop/SmartCity-Application/SmartCity/img/Mumbai/new/a6ca97e08752c29c9afbfe8b7064b8c3.jpg"));

		JLabel lalbagh2 = new JLabel();
		lalbagh2.setBounds(980, 550, 450, 200);
		back.add(lalbagh2);
		SetImageSize(lalbagh2, new ImageIcon(
				"/Users/kanishkamishra/Desktop/SmartCity-Application/SmartCity/img/Mumbai/new/market1-625x383.jpg"));
